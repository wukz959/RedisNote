...
**==写在前面==**，我是直接在服务器里安装mysql（根据MySQL教程高级pdf配置的），并没有使用下面提到的docker。
...
<img src="案例导入说明.assets/image-20230306212122973.png" alt="image-20230306212122973" style="zoom:67%;" />
...
**==写在前面==**，我是运行了会报错，然后知道了lombook版本为1.18.20，还修改了项目的jdk版本（这一步不知道有没有成功，就是修改了pom的jdk版本以及参考链接https://blog.csdn.net/weixin_67418985/article/details/127349927）。
...
ps：启动时如果报下面的错，就根据报错路径在指定路径下创建temp/client_body_temp文件夹

![image-20230307103737407](案例导入说明.assets/image-20230307103737407.png)
